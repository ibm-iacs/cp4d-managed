...
```mdx path=components/Video/Video.js src=https://github.com/ibm-iacs/cp4d-managed/tree/main/packages/gatsby-theme-carbon/src/components/Video
...
```mdx path=components/Video.mdx src=https://github.com/ibm-iacs/cp4d-managed/blob/main/packages/example/src/pages/components/Video/index.mdx
import localVideo from './local-video.mp4';
import localPoster from './local-poster.jpg';
