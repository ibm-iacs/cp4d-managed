...
```mdx path=components/DoDontExample/DoDontExample.js src=https://github.com/ibm-iacs/cp4d-managed/tree/main/packages/gatsby-theme-carbon/src/components/DoDontExample
<DoDontExample type="do" captionTitle="Caption title" caption="Caption">
...
| aspectRatio  | string   |          |         | set to `1:1` to force square example <br/>_(We welcome [contributions](https://github.com/ibm-iacs/cp4d-managed/tree/main/packages/gatsby-theme-carbon/src/components/DoDontExample) to add additional aspect ratio options)_ |
