...
<Accordion>
  <AccordionItem title="Title 1">IBM Support guide</AccordionItem>
  <AccordionItem title="Title 2">Steps to be follow</AccordionItem>
  <AccordionItem title="Title 3">Site links</AccordionItem>
</Accordion>
