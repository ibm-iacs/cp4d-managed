---
title: Demo_mohita
description: Demonstration of some of the theme components in action. Demonstration of some of the theme components in action.
---
...
[on github](https://github.com/ibm-iacs/cp4d-managed/blob/main/packages/example/src/pages/demo/index.mdx).
