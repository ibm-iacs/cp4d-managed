...
1. Open a
   [quick issue](https://github.com/ibm-iacs/cp4d-managed/issues/new)
...
1. Create a directory the same name as the component you wish to shadow.
   ...
   [src directory of gatsby-theme-carbon](https://github.com/ibm-iacs/cp4d-managed/tree/main/packages/gatsby-theme-carbon/src).
...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| ResourceLinks | [`src/gatsby-theme-carbon/components/LeftNav/ResourceLinks.js`](https://github.com/ibm-iacs/cp4d-managed/blob/main/packages/example/src/gatsby-theme-carbon/components/LeftNav/ResourceLinks.js) | The bottom links on the SideNav, pass `shouldOpenNewTabs` to open links externally |
| Footer        | [`src/gatsby-theme-carbon/components/Footer/index.js`](https://github.com/ibm-iacs/cp4d-managed/blob/main/packages/example/src/gatsby-theme-carbon/components/Footer/index.js)                               | The links and content at the bottom of each page                                   |
| Header        | [`src/gatsby-theme-carbon/components/Header/index.js`](https://github.com/ibm-iacs/cp4d-managed/blob/main/packages/example/src/gatsby-theme-carbon/components/Header/index.js)                               | The text in the top left corner of the UI Shell                                    |
