...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| ResourceLinks | [`src/gatsby-theme-carbon/components/LeftNav/ResourceLinks.js`](https://github.com/ibm-iacs/cp4d-managed/blob/main//src/gatsby-theme-carbon/components/LeftNav/ResourceLinks.js) | The bottom links on the SideNav, pass `shouldOpenNewTabs` to open links externally |
| Footer        | [`src/gatsby-theme-carbon/components/Footer/index.js`](https://github.com/ibm-iacs/cp4d-managed/blob/main//src/gatsby-theme-carbon/components/Footer/index.js)                               | The links and content at the bottom of each page                                   |
| Header        | [`src/gatsby-theme-carbon/components/Header/index.js`](https://github.com/ibm-iacs/cp4d-managed/blob/main//src/gatsby-theme-carbon/components/Header/index.js)                               | The text in the top left corner of the UI Shell                                    |
