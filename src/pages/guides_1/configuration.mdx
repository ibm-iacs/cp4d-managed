...
[`gatsby-config.js`](https://github.com/ibm-iacs/cp4d-managed/blob/main/packages/gatsby-theme-carbon/gatsby-config.js)
file.
...
- `titleType` – pick between four formats for the `<title>` element for your
  ...
  - `site`: "IBM Expert Labs"
  - `append`: "IBM Expert Labs – Configuration"
  - `prepend`: "Configuration - IBM Expert Labs"
